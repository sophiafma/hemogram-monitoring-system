...
echo "   # 1. Gerar JSONs:"
echo "   python3 $APP_DIR/scripts/test-data/generate_hemogram_bundles.py"
echo ""
echo "   # 2. Enviar para servidor FHIR:"
echo "   bash $APP_DIR/scripts/test-data/send-to-fhir-server.sh"
echo ""
